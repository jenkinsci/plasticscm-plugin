...
//        assertEquals(FormValidation.Kind.OK, descriptor.doCheckExecutable("C:\\Program Files\\PlasticSCM5\\client\\cm.exe").kind);
//        assertEquals(FormValidation.Kind.ERROR, descriptor.doCheckExecutable("/invalid-path/cm").kind);
//        assertEquals(FormValidation.Kind.ERROR, descriptor.doCheckExecutable("invalid-binary").kind);
    }
